...
static const char *tags11[] = { "thor", "warrior", "man", NULL};
static const char *tags12[] = { "kyra", "valkyrie", "woman", NULL};
...
OBJECT objs[] = {
	...
	{	/* 4 = waitingRoomWall */
		...
		NULL,
		NULL,
		 "Written on the wall, it says: play YourName.",
		"You see",
